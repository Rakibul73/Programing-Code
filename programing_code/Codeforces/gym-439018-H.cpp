...
void solve() {
    ...
    vector<long long> zzzzzz(n);
    for (long long i = 0; i < n; i++) {
        cin >> zzzzzz[i];
    }
    sort(zzzzzz.begin() , zzzzzz.end());
    long long a = zzzzzz[n-1]*zzzzzz[n-2]*zzzzzz[n-3];
    long long b = zzzzzz[0]*zzzzzz[1]*zzzzzz[2];
    long long c = zzzzzz[0]*zzzzzz[1]*zzzzzz[n-1];
    long long d = zzzzzz[0]*zzzzzz[n-1]*zzzzzz[n-2];
