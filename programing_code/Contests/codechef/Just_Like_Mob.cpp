...
// last modified: 2022/11/24 00:04:35
...
void solve() {
    long long n , m , k , x, val_lagena = 0;
    cin>>n>>m>>k>>x;
    long long ore_chodon = k-1;
    ...
    long long chudi = x % val_lagena;
    if(chudi == 0) {
        cout<<"YES\n";
        return;
    }
    val_lagena = 0;
    val_lagena = n*ore_chodon;
    if(chudi > val_lagena) {
        cout<<"YES\n";
        return;
    }
    ...
    // val_lagena = val_lagena + n + m;
    // if(chudi < val_lagena) {
    //     cout<<"YES\n";
    //     return;
    // }
    
    // for (long long i = ore_chodon; i < 100000; i++)
    // {
    //     val_lagena = val_lagena + (n*ore_chodon);
    //     if(x < val_lagena) {
    //         cout<<"NO\n";
    //         return;
    //     }
